...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference("Achievement.count") do
      post achievements_url, params: { achievement: { category: @achievement.category, date: @achievement.date, description: @achievement.description, student_name: @achievement.student_name, title: @achievement.title } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { category: @achievement.category, date: @achievement.date, description: @achievement.description, student_name: @achievement.student_name, title: @achievement.title } }
